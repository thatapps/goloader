...
import com.becapps.easydownloader.service.FfmpegDownloadService;
...
public class SettingsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.quick_start_home).create().show();
	                        ...
	                        adb.setPositiveButton("OK", new DialogInterface.OnClickListener() {
	                            ...
	                            public void onClick(DialogInterface dialog, int which) {
	                                ...
	                                try {
		                                ...
		                                i.putExtra(Intent.EXTRA_EMAIL, new String[] { "niteshbhatia456@gmail.com" });
		                                i.putExtra(Intent.EXTRA_SUBJECT, "Easy Video Downloader: device info report");
